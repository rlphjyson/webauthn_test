...
const makeCredentialJson = '''{
    ...
    "clientDataHash": "/HopKMIvgL+nz/eyCpzvIQOiIl1FQmX6sebLWKL4eGk=",
    ...
    "rp": {
        "id": "southeastasia.azurecontainerapps.io",
        "name": "Tng_Identity_Server",
        "icon": "https://pinetworks.net/wp-content/uploads/2023/03/logos_horizontal.svg"
    },
    "user": {
        "name": "503498708",
        "id": "YzJmMGFkYjUtZjc2ZS00NDIzLWFhY2YtNmIzYmYxMzg3YTRl",
        "displayName": "503498708"
    }
}''';
...
class _MyHomePageState extends State<MyHomePage> {
  final _auth = Authenticator(true, true);
  ...
  void _createCredential() async {
    final credential = await _lockAndExecute(false, () async {
      try {
        ...
        print('attestation: $attestationJson');
        setState(() {
